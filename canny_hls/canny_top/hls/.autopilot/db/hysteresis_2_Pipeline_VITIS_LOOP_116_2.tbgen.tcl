set moduleName hysteresis_2_Pipeline_VITIS_LOOP_116_2
set isTopModule 0
...
set cdfgNum 40
set C_modelName {hysteresis<2>_Pipeline_VITIS_LOOP_116_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "out_hysteresis2", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "result_5", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ result_5 sc_in sc_lv 2 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_5", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "result_5", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	result_5 { ap_none {  { result_5 in_data 0 2 } } }
