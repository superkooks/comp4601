...
dict set ap_memory_interface_dict lineBuffer_magnitude { MEM_WIDTH 16 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_direction { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_magnitude_1 { MEM_WIDTH 16 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_direction_1 { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_magnitude_2 { MEM_WIDTH 16 MEM_SIZE 1024 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_direction_2 { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ tmp_4 int 8 regular  }
	...
	{ lineBuffer_magnitude int 16 regular {array 512 { 1 3 } 1 1 }  }
	{ lineBuffer_direction int 8 regular {array 512 { 1 3 } 1 1 }  }
	{ lineBuffer_magnitude_1 int 16 regular {array 512 { 1 3 } 1 1 }  }
	{ lineBuffer_direction_1 int 8 regular {array 512 { 1 3 } 1 1 }  }
	{ lineBuffer_magnitude_2 int 16 regular {array 512 { 1 3 } 1 1 }  }
	{ lineBuffer_direction_2 int 8 regular {array 512 { 1 3 } 1 1 }  }
...
set Spec2ImplPortList { 
	...
	lineBuffer_magnitude { ap_memory {  { lineBuffer_magnitude_address0 mem_address 1 9 }  { lineBuffer_magnitude_ce0 mem_ce 1 1 }  { lineBuffer_magnitude_q0 mem_dout 0 16 } } }
	lineBuffer_direction { ap_memory {  { lineBuffer_direction_address0 mem_address 1 9 }  { lineBuffer_direction_ce0 mem_ce 1 1 }  { lineBuffer_direction_q0 mem_dout 0 8 } } }
	lineBuffer_magnitude_1 { ap_memory {  { lineBuffer_magnitude_1_address0 mem_address 1 9 }  { lineBuffer_magnitude_1_ce0 mem_ce 1 1 }  { lineBuffer_magnitude_1_q0 mem_dout 0 16 } } }
	lineBuffer_direction_1 { ap_memory {  { lineBuffer_direction_1_address0 mem_address 1 9 }  { lineBuffer_direction_1_ce0 mem_ce 1 1 }  { lineBuffer_direction_1_q0 mem_dout 0 8 } } }
	lineBuffer_magnitude_2 { ap_memory {  { lineBuffer_magnitude_2_address0 mem_address 1 9 }  { lineBuffer_magnitude_2_ce0 mem_ce 1 1 }  { lineBuffer_magnitude_2_q0 mem_dout 0 16 } } }
	lineBuffer_direction_2 { ap_memory {  { lineBuffer_direction_2_address0 mem_address 1 9 }  { lineBuffer_direction_2_ce0 mem_ce 1 1 }  { lineBuffer_direction_2_q0 mem_dout 0 8 } } }
