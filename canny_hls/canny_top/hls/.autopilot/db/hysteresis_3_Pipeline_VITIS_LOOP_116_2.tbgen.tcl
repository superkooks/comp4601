set moduleName hysteresis_3_Pipeline_VITIS_LOOP_116_2
set isTopModule 0
...
set cdfgNum 40
set C_modelName {hysteresis<3>_Pipeline_VITIS_LOOP_116_2}
...
set C_modelArgMapList {[ 
	{ "Name" : "out_hysteresis3", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "result_4", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ result_4 sc_in sc_lv 2 signal 1 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "result_4", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "result_4", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	result_4 { ap_none {  { result_4 in_data 0 2 } } }
