...
dict set ap_memory_interface_dict lineBuffer_4 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_3 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_2 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_1 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ sample2 int 8 regular  }
	{ sample1 int 8 regular  }
	{ sample0 int 8 regular  }
	{ gray_out int 8 regular {fifo 0 volatile }  }
	{ lineBuffer_4 int 12 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_3 int 12 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_2 int 12 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_1 int 12 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer int 12 regular {array 640 { 0 3 } 0 1 }  }
	{ empty int 3 regular  }
}
set hasAXIMCache 0
...
set portList { 
	...
	{ gray_out_num_data_valid sc_in sc_lv 12 signal 3 } 
	{ gray_out_fifo_cap sc_in sc_lv 12 signal 3 } 
	{ sample2 sc_in sc_lv 8 signal 0 } 
	{ sample1 sc_in sc_lv 8 signal 1 } 
	{ sample0 sc_in sc_lv 8 signal 2 } 
	{ lineBuffer_4_address0 sc_out sc_lv 10 signal 4 } 
	...
	{ lineBuffer_3_address0 sc_out sc_lv 10 signal 5 } 
	...
	{ lineBuffer_2_address0 sc_out sc_lv 10 signal 6 } 
	...
	{ lineBuffer_1_address0 sc_out sc_lv 10 signal 7 } 
	...
	{ lineBuffer_address0 sc_out sc_lv 10 signal 8 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "lineBuffer_4_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "lineBuffer_4", "role": "address0" }} , 
 	...
 	{ "name": "lineBuffer_3_address0", "direction": "out", "datatype": "sc_lv", "bitwidth":10, "type": "signal", "bundle":{"name": "lineBuffer_3", "role": "address0" }} , 
...
set Spec2ImplPortList { 
	...
	lineBuffer_4 { ap_memory {  { lineBuffer_4_address0 mem_address 1 10 }  { lineBuffer_4_ce0 mem_ce 1 1 }  { lineBuffer_4_we0 mem_we 1 1 }  { lineBuffer_4_d0 mem_din 1 12 } } }
	lineBuffer_3 { ap_memory {  { lineBuffer_3_address0 mem_address 1 10 }  { lineBuffer_3_ce0 mem_ce 1 1 }  { lineBuffer_3_we0 mem_we 1 1 }  { lineBuffer_3_d0 mem_din 1 12 } } }
	lineBuffer_2 { ap_memory {  { lineBuffer_2_address0 mem_address 1 10 }  { lineBuffer_2_ce0 mem_ce 1 1 }  { lineBuffer_2_we0 mem_we 1 1 }  { lineBuffer_2_d0 mem_din 1 12 } } }
	lineBuffer_1 { ap_memory {  { lineBuffer_1_address0 mem_address 1 10 }  { lineBuffer_1_ce0 mem_ce 1 1 }  { lineBuffer_1_we0 mem_we 1 1 }  { lineBuffer_1_d0 mem_din 1 12 } } }
	lineBuffer { ap_memory {  { lineBuffer_address0 mem_address 1 10 }  { lineBuffer_ce0 mem_ce 1 1 }  { lineBuffer_we0 mem_we 1 1 }  { lineBuffer_d0 mem_din 1 12 } } }
