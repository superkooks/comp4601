...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { hyst3_out_din { O 8 vector } hyst3_out_full_n { I 1 bit } hyst3_out_write { O 1 bit } hyst3_out_num_data_valid { I 32 vector } hyst3_out_fifo_cap { I 32 vector } } \
} "
}
