...
dict set ap_memory_interface_dict lineBuffer { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_1 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_2 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_3 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_4 { MEM_WIDTH 12 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ lineBuffer int 12 regular {array 640 { 1 3 } 1 1 }  }
	{ lineBuffer_1 int 12 regular {array 640 { 1 3 } 1 1 }  }
	{ lineBuffer_2 int 12 regular {array 640 { 1 3 } 1 1 }  }
	{ lineBuffer_3 int 12 regular {array 640 { 1 3 } 1 1 }  }
	{ lineBuffer_4 int 12 regular {array 640 { 1 3 } 1 1 }  }
	{ select_ln21 int 3 regular  }
	{ select_ln21_1 int 3 regular  }
	{ empty_46 int 3 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "lineBuffer", "interface" : "memory", "bitwidth" : 12, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "empty_46", "interface" : "wire", "bitwidth" : 3, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ lineBuffer_address0 sc_out sc_lv 10 signal 0 } 
	...
	{ lineBuffer_2_address0 sc_out sc_lv 10 signal 2 } 
	{ lineBuffer_2_ce0 sc_out sc_logic 1 signal 2 } 
	{ lineBuffer_2_q0 sc_in sc_lv 12 signal 2 } 
	{ lineBuffer_3_address0 sc_out sc_lv 10 signal 3 } 
	...
	{ empty_46 sc_in sc_lv 3 signal 7 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_46", "direction": "in", "datatype": "sc_lv", "bitwidth":3, "type": "signal", "bundle":{"name": "empty_46", "role": "default" }} , 
...
set Spec2ImplPortList { 
	lineBuffer { ap_memory {  { lineBuffer_address0 mem_address 1 10 }  { lineBuffer_ce0 mem_ce 1 1 }  { lineBuffer_q0 mem_dout 0 12 } } }
	lineBuffer_1 { ap_memory {  { lineBuffer_1_address0 mem_address 1 10 }  { lineBuffer_1_ce0 mem_ce 1 1 }  { lineBuffer_1_q0 mem_dout 0 12 } } }
	lineBuffer_2 { ap_memory {  { lineBuffer_2_address0 mem_address 1 10 }  { lineBuffer_2_ce0 mem_ce 1 1 }  { lineBuffer_2_q0 mem_dout 0 12 } } }
	lineBuffer_3 { ap_memory {  { lineBuffer_3_address0 mem_address 1 10 }  { lineBuffer_3_ce0 mem_ce 1 1 }  { lineBuffer_3_q0 mem_dout 0 12 } } }
	lineBuffer_4 { ap_memory {  { lineBuffer_4_address0 mem_address 1 10 }  { lineBuffer_4_ce0 mem_ce 1 1 }  { lineBuffer_4_q0 mem_dout 0 12 } } }
	select_ln21 { ap_none {  { select_ln21 in_data 0 3 } } }
	select_ln21_1 { ap_none {  { select_ln21_1 in_data 0 3 } } }
	empty_46 { ap_none {  { empty_46 in_data 0 3 } } }
