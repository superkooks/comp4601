...
void sobel(
    ...
    VITIS_LOOP_82_1: for (int column = 0; column < WIDTH; ++column) {
    ...
    VITIS_LOOP_109_2: for (int column = 1; column < WIDTH - 1; ++column) {
        int gradientX = 0;
        int gradientY = 0;

        VITIS_LOOP_113_3: for (int kernelRow = 0;
            ...
            VITIS_LOOP_126_4: for (int kernelColumn = 0;
