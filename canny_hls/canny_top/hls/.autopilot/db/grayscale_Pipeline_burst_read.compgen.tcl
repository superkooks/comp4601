...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename row_words \
    op interface \
    ports { row_words_address0 { O 5 vector } row_words_ce0 { O 1 bit } row_words_we0 { O 1 bit } row_words_d0 { O 512 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'row_words'"
}
}
