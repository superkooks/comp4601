...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler canny_top_non_maximum_suppression_p_anonymous_namespace_lineBuffer_direction_RAM_AUTO_1bkb BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}


if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler canny_top_non_maximum_suppression_p_anonymous_namespace_lineBuffer_11_magnitude_0_RAM_Acud BINDTYPE {storage} TYPE {ram} IMPL {auto} LATENCY 2 ALLOW_PRAGMA 1
}
