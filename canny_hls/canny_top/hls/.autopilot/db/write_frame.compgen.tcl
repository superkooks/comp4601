...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_hyst4_out \
    op interface \
    ports { hyst4_out_dout { I 8 vector } hyst4_out_empty_n { I 1 bit } hyst4_out_read { O 1 bit } hyst4_out_num_data_valid { I 11 vector } hyst4_out_fifo_cap { I 11 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_out_r \
    op interface \
    ports { out_r_dout { I 64 vector } out_r_empty_n { I 1 bit } out_r_read { O 1 bit } out_r_num_data_valid { I 5 vector } out_r_fifo_cap { I 5 vector } } \
} "
}
...
set InstName canny_top_flow_control_loop_delay_pipe_U
set CompName canny_top_flow_control_loop_delay_pipe
