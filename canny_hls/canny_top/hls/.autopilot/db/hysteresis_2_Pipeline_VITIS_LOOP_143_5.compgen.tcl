...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { hyst2_out_din { O 8 vector } hyst2_out_full_n { I 1 bit } hyst2_out_write { O 1 bit } hyst2_out_num_data_valid { I 32 vector } hyst2_out_fifo_cap { I 32 vector } } \
} "
}
