...
dict set ap_memory_interface_dict out_grayscale { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "2132", "Max" : "2132"}
	, {"Name" : "Interval", "Min" : "2132", "Max" : "2132"}
]}
...
set Spec2ImplPortList { 
	...
	in_r { ap_stable {  { in_r in_data 0 64 } } }
