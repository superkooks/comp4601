...
entity canny_top_start_for_double_threshold_U0 is 
    generic (
...
architecture rtl of canny_top_start_for_double_threshold_U0 is
...
------------------------Component----------------------
    component canny_top_start_for_double_threshold_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
...
begin
----------------------- Instantiation -----------------------
    U_canny_top_start_for_double_threshold_U0_ShiftReg : canny_top_start_for_double_threshold_U0_ShiftReg
    generic map (
...
entity canny_top_start_for_double_threshold_U0_ShiftReg is
    generic (
        DATA_WIDTH : integer := 1;
        ADDR_WIDTH : integer := 1;
        DEPTH      : integer := 2);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end canny_top_start_for_double_threshold_U0_ShiftReg;

architecture rtl of canny_top_start_for_double_threshold_U0_ShiftReg is
