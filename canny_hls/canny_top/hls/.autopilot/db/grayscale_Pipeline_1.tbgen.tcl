set moduleName grayscale_Pipeline_1
set isTopModule 0
...
set cdfgNum 41
set C_modelName {grayscale_Pipeline_1}
set C_modelType { void 0 }
set ap_memory_interface_dict [dict create]
dict set ap_memory_interface_dict local_blue { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict local_green { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict local_red { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ empty int 64 regular  }
	{ gmem int 512 regular {axi_master 0}  }
	{ local_blue int 8 regular {array 512 { 0 3 } 0 1 }  }
	{ local_green int 8 regular {array 512 { 0 3 } 0 1 }  }
	{ local_red int 8 regular {array 512 { 0 3 } 0 1 }  }
}
set hasAXIMCache 0
...
set C_modelArgMapList {[ 
	{ "Name" : "empty", "interface" : "wire", "bitwidth" : 64, "direction" : "READONLY"} , 
 	{ "Name" : "gmem", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"},{"cName": "out_r","offset": { "type": "dynamic","port_name": "out_r","bundle": "control"},"direction": "WRITEONLY"}]}]} , 
 	{ "Name" : "local_blue", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_green", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} , 
 	{ "Name" : "local_red", "interface" : "memory", "bitwidth" : 8, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ local_blue_address0 sc_out sc_lv 9 signal 2 } 
	{ local_blue_ce0 sc_out sc_logic 1 signal 2 } 
	{ local_blue_we0 sc_out sc_logic 1 signal 2 } 
	{ local_blue_d0 sc_out sc_lv 8 signal 2 } 
	{ local_green_address0 sc_out sc_lv 9 signal 3 } 
	{ local_green_ce0 sc_out sc_logic 1 signal 3 } 
	{ local_green_we0 sc_out sc_logic 1 signal 3 } 
	{ local_green_d0 sc_out sc_lv 8 signal 3 } 
	{ local_red_address0 sc_out sc_lv 9 signal 4 } 
	{ local_red_ce0 sc_out sc_logic 1 signal 4 } 
	{ local_red_we0 sc_out sc_logic 1 signal 4 } 
	{ local_red_d0 sc_out sc_lv 8 signal 4 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "local_blue_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_blue", "role": "we0" }} , 
 	{ "name": "local_blue_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_blue", "role": "d0" }} , 
 	...
 	{ "name": "local_green_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_green", "role": "we0" }} , 
 	{ "name": "local_green_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_green", "role": "d0" }} , 
 	...
 	{ "name": "local_red_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "local_red", "role": "we0" }} , 
 	{ "name": "local_red_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":8, "type": "signal", "bundle":{"name": "local_red", "role": "d0" }}  ]}
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1610", "Max" : "1610"}
...
set Spec2ImplPortList { 
	...
	local_blue { ap_memory {  { local_blue_address0 mem_address 1 9 }  { local_blue_ce0 mem_ce 1 1 }  { local_blue_we0 mem_we 1 1 }  { local_blue_d0 mem_din 1 8 } } }
	local_green { ap_memory {  { local_green_address0 mem_address 1 9 }  { local_green_ce0 mem_ce 1 1 }  { local_green_we0 mem_we 1 1 }  { local_green_d0 mem_din 1 8 } } }
	local_red { ap_memory {  { local_red_address0 mem_address 1 9 }  { local_red_ce0 mem_ce 1 1 }  { local_red_we0 mem_we 1 1 }  { local_red_d0 mem_din 1 8 } } }
}
