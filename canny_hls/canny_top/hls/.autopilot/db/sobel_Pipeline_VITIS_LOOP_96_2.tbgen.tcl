...
dict set ap_memory_interface_dict lineBuffer_2 { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_1 { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer { MEM_WIDTH 8 MEM_SIZE 512 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ lineBuffer_2 int 8 regular {array 512 { 0 3 } 0 1 }  }
	{ lineBuffer_1 int 8 regular {array 512 { 0 3 } 0 1 }  }
	{ lineBuffer int 8 regular {array 512 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ gauss_out_num_data_valid sc_in sc_lv 11 signal 3 } 
	{ gauss_out_fifo_cap sc_in sc_lv 11 signal 3 } 
	{ lineBuffer_2_address0 sc_out sc_lv 9 signal 0 } 
	...
	{ lineBuffer_address0 sc_out sc_lv 9 signal 2 } 
...
set Spec2ImplPortList { 
	lineBuffer_2 { ap_memory {  { lineBuffer_2_address0 mem_address 1 9 }  { lineBuffer_2_ce0 mem_ce 1 1 }  { lineBuffer_2_we0 mem_we 1 1 }  { lineBuffer_2_d0 mem_din 1 8 } } }
	lineBuffer_1 { ap_memory {  { lineBuffer_1_address0 mem_address 1 9 }  { lineBuffer_1_ce0 mem_ce 1 1 }  { lineBuffer_1_we0 mem_we 1 1 }  { lineBuffer_1_d0 mem_din 1 8 } } }
	lineBuffer { ap_memory {  { lineBuffer_address0 mem_address 1 9 }  { lineBuffer_ce0 mem_ce 1 1 }  { lineBuffer_we0 mem_we 1 1 }  { lineBuffer_d0 mem_din 1 8 } } }
