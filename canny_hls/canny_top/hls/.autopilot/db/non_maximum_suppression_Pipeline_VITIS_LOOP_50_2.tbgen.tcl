...
dict set ap_memory_interface_dict lineBuffer_direction_2 { MEM_WIDTH 8 MEM_SIZE 640 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_direction_1 { MEM_WIDTH 8 MEM_SIZE 640 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_direction { MEM_WIDTH 8 MEM_SIZE 640 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_magnitude_2 { MEM_WIDTH 16 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_magnitude_1 { MEM_WIDTH 16 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
dict set ap_memory_interface_dict lineBuffer_magnitude { MEM_WIDTH 16 MEM_SIZE 1280 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 0 }
set C_modelArgList {
	{ lineBuffer_direction_2 int 8 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_direction_1 int 8 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_direction int 8 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_magnitude_2 int 16 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_magnitude_1 int 16 regular {array 640 { 0 3 } 0 1 }  }
	{ lineBuffer_magnitude int 16 regular {array 640 { 0 3 } 0 1 }  }
...
set portList { 
	...
	{ sobel_out_num_data_valid sc_in sc_lv 12 signal 6 } 
	{ sobel_out_fifo_cap sc_in sc_lv 12 signal 6 } 
	{ lineBuffer_direction_2_address0 sc_out sc_lv 10 signal 0 } 
	...
	{ lineBuffer_direction_1_address0 sc_out sc_lv 10 signal 1 } 
	...
	{ lineBuffer_direction_address0 sc_out sc_lv 10 signal 2 } 
	...
	{ lineBuffer_magnitude_2_address0 sc_out sc_lv 10 signal 3 } 
	...
	{ lineBuffer_magnitude_1_address0 sc_out sc_lv 10 signal 4 } 
	...
	{ lineBuffer_magnitude_address0 sc_out sc_lv 10 signal 5 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "sobel_out_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sobel_out", "role": "num_data_valid" }} , 
 	{ "name": "sobel_out_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":12, "type": "signal", "bundle":{"name": "sobel_out", "role": "fifo_cap" }} , 
...
set Spec2ImplPortList { 
	lineBuffer_direction_2 { ap_memory {  { lineBuffer_direction_2_address0 mem_address 1 10 }  { lineBuffer_direction_2_ce0 mem_ce 1 1 }  { lineBuffer_direction_2_we0 mem_we 1 1 }  { lineBuffer_direction_2_d0 mem_din 1 8 } } }
	lineBuffer_direction_1 { ap_memory {  { lineBuffer_direction_1_address0 mem_address 1 10 }  { lineBuffer_direction_1_ce0 mem_ce 1 1 }  { lineBuffer_direction_1_we0 mem_we 1 1 }  { lineBuffer_direction_1_d0 mem_din 1 8 } } }
	lineBuffer_direction { ap_memory {  { lineBuffer_direction_address0 mem_address 1 10 }  { lineBuffer_direction_ce0 mem_ce 1 1 }  { lineBuffer_direction_we0 mem_we 1 1 }  { lineBuffer_direction_d0 mem_din 1 8 } } }
	lineBuffer_magnitude_2 { ap_memory {  { lineBuffer_magnitude_2_address0 mem_address 1 10 }  { lineBuffer_magnitude_2_ce0 mem_ce 1 1 }  { lineBuffer_magnitude_2_we0 mem_we 1 1 }  { lineBuffer_magnitude_2_d0 mem_din 1 16 } } }
	lineBuffer_magnitude_1 { ap_memory {  { lineBuffer_magnitude_1_address0 mem_address 1 10 }  { lineBuffer_magnitude_1_ce0 mem_ce 1 1 }  { lineBuffer_magnitude_1_we0 mem_we 1 1 }  { lineBuffer_magnitude_1_d0 mem_din 1 16 } } }
	lineBuffer_magnitude { ap_memory {  { lineBuffer_magnitude_address0 mem_address 1 10 }  { lineBuffer_magnitude_ce0 mem_ce 1 1 }  { lineBuffer_magnitude_we0 mem_we 1 1 }  { lineBuffer_magnitude_d0 mem_din 1 16 } } }
	sobel_out { ap_fifo {  { sobel_out_dout fifo_data_out 0 24 }  { sobel_out_empty_n fifo_status_empty 0 1 }  { sobel_out_read fifo_data_in 1 1 }  { sobel_out_num_data_valid fifo_update 0 12 }  { sobel_out_fifo_cap fifo_data 0 12 } } }
