set moduleName dataflow_in_loop_VITIS_LOOP_11_1_1_Block_newFuncRoot_proc
set isTopModule 0
...
set cdfgNum 40
set C_modelName {dataflow_in_loop_VITIS_LOOP_11_1.1_Block_newFuncRoot_proc}
