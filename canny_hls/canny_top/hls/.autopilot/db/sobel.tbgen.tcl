...
set portList { 
	...
	{ lineBuffer_we0 sc_out sc_logic 1 signal 5 } 
	{ lineBuffer_d0 sc_out sc_lv 8 signal 5 } 
...
set PerformanceInfo {[
	{"Name" : "Latency", "Min" : "1", "Max" : "2640"}
	, {"Name" : "Interval", "Min" : "1", "Max" : "2640"}
]}
...
set Spec2ImplPortList { 
	...
	lineBuffer { ap_memory {  { lineBuffer_address0 mem_address 1 11 }  { lineBuffer_ce0 mem_ce 1 1 }  { lineBuffer_we0 mem_we 1 1 }  { lineBuffer_d0 mem_din 1 8 }  { lineBuffer_q0 mem_dout 0 8 }  { lineBuffer_address1 MemPortADDR2 1 11 }  { lineBuffer_ce1 MemPortCE2 1 1 }  { lineBuffer_q1 MemPortDOUT2 0 8 } } }
}
