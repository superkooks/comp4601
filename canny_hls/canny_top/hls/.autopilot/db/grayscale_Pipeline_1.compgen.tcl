...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename local_blue \
    op interface \
    ports { local_blue_address0 { O 9 vector } local_blue_ce0 { O 1 bit } local_blue_we0 { O 1 bit } local_blue_d0 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_blue'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    sync_rst true \
    dir O \
    corename local_green \
    op interface \
    ports { local_green_address0 { O 9 vector } local_green_ce0 { O 1 bit } local_green_we0 { O 1 bit } local_green_d0 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_green'"
}
}
...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename local_red \
    op interface \
    ports { local_red_address0 { O 9 vector } local_red_ce0 { O 1 bit } local_red_we0 { O 1 bit } local_red_d0 { O 8 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'local_red'"
}
}
