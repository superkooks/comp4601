...
set portList { 
	...
	{ out_hysteresis_address0 sc_out sc_lv 9 signal 1 } 
	{ out_hysteresis_ce0 sc_out sc_logic 1 signal 1 } 
	{ out_hysteresis_q0 sc_in sc_lv 2 signal 1 } 
	{ m_axi_gmem_out_0_AWVALID sc_out sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_AWREADY sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_AWADDR sc_out sc_lv 64 signal 2 } 
	{ m_axi_gmem_out_0_AWID sc_out sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_AWLEN sc_out sc_lv 32 signal 2 } 
	{ m_axi_gmem_out_0_AWSIZE sc_out sc_lv 3 signal 2 } 
	{ m_axi_gmem_out_0_AWBURST sc_out sc_lv 2 signal 2 } 
	{ m_axi_gmem_out_0_AWLOCK sc_out sc_lv 2 signal 2 } 
	{ m_axi_gmem_out_0_AWCACHE sc_out sc_lv 4 signal 2 } 
	{ m_axi_gmem_out_0_AWPROT sc_out sc_lv 3 signal 2 } 
	{ m_axi_gmem_out_0_AWQOS sc_out sc_lv 4 signal 2 } 
	{ m_axi_gmem_out_0_AWREGION sc_out sc_lv 4 signal 2 } 
	{ m_axi_gmem_out_0_AWUSER sc_out sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_WVALID sc_out sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_WREADY sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_WDATA sc_out sc_lv 512 signal 2 } 
	{ m_axi_gmem_out_0_WSTRB sc_out sc_lv 64 signal 2 } 
	{ m_axi_gmem_out_0_WLAST sc_out sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_WID sc_out sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_WUSER sc_out sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_ARVALID sc_out sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_ARREADY sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_ARADDR sc_out sc_lv 64 signal 2 } 
	{ m_axi_gmem_out_0_ARID sc_out sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_ARLEN sc_out sc_lv 32 signal 2 } 
	{ m_axi_gmem_out_0_ARSIZE sc_out sc_lv 3 signal 2 } 
	{ m_axi_gmem_out_0_ARBURST sc_out sc_lv 2 signal 2 } 
	{ m_axi_gmem_out_0_ARLOCK sc_out sc_lv 2 signal 2 } 
	{ m_axi_gmem_out_0_ARCACHE sc_out sc_lv 4 signal 2 } 
	{ m_axi_gmem_out_0_ARPROT sc_out sc_lv 3 signal 2 } 
	{ m_axi_gmem_out_0_ARQOS sc_out sc_lv 4 signal 2 } 
	{ m_axi_gmem_out_0_ARREGION sc_out sc_lv 4 signal 2 } 
	{ m_axi_gmem_out_0_ARUSER sc_out sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_RVALID sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_RREADY sc_out sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_RDATA sc_in sc_lv 512 signal 2 } 
	{ m_axi_gmem_out_0_RLAST sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_RID sc_in sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_RFIFONUM sc_in sc_lv 9 signal 2 } 
	{ m_axi_gmem_out_0_RUSER sc_in sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_RRESP sc_in sc_lv 2 signal 2 } 
	{ m_axi_gmem_out_0_BVALID sc_in sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_BREADY sc_out sc_logic 1 signal 2 } 
	{ m_axi_gmem_out_0_BRESP sc_in sc_lv 2 signal 2 } 
	{ m_axi_gmem_out_0_BID sc_in sc_lv 1 signal 2 } 
	{ m_axi_gmem_out_0_BUSER sc_in sc_lv 1 signal 2 } 
	{ out_r_dout sc_in sc_lv 64 signal 3 } 
	{ out_r_empty_n sc_in sc_logic 1 signal 3 } 
	{ out_r_read sc_out sc_logic 1 signal 3 } 
	{ out_r_num_data_valid sc_in sc_lv 5 signal 3 } 
	{ out_r_fifo_cap sc_in sc_lv 5 signal 3 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "out_r_num_data_valid", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "out_r", "role": "num_data_valid" }} , 
 	{ "name": "out_r_fifo_cap", "direction": "in", "datatype": "sc_lv", "bitwidth":5, "type": "signal", "bundle":{"name": "out_r", "role": "fifo_cap" }}  ]}
...
set Spec2ImplPortList { 
	...
	out_r { ap_fifo {  { out_r_dout fifo_data_out 0 64 }  { out_r_empty_n fifo_status_empty 0 1 }  { out_r_read fifo_data_in 1 1 }  { out_r_num_data_valid fifo_update 0 5 }  { out_r_fifo_cap fifo_data 0 5 } } }
}
