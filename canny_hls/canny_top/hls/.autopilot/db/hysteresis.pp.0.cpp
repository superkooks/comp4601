...
void hysteresis_reset() {
    ...
    VITIS_LOOP_39_1: for (int row = 0; row < WINDOW_SIZE; ++row) {
        VITIS_LOOP_40_2: for (int column = 0; column < WIDTH; ++column) {
...
void hysteresis(
    ...
    VITIS_LOOP_60_1: for (int column = 0; column < WIDTH; ++column) {
    ...
    VITIS_LOOP_108_2: for (int column = 1; column < WIDTH - 1; ++column) {
