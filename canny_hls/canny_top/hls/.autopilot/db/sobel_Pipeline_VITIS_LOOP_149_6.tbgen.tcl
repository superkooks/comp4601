...
dict set ap_memory_interface_dict lineBuffer { MEM_WIDTH 8 MEM_SIZE 640 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_1 { MEM_WIDTH 8 MEM_SIZE 640 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
dict set ap_memory_interface_dict lineBuffer_2 { MEM_WIDTH 8 MEM_SIZE 640 MASTER_TYPE BRAM_CTRL MEM_ADDRESS_MODE WORD_ADDRESS PACKAGE_IO port READ_LATENCY 1 }
set C_modelArgList {
	{ tmp_2 int 8 regular  }
	{ tmp_6 int 8 regular  }
	{ tmp_3 int 8 regular  }
	...
	{ lineBuffer int 8 regular {array 640 { 1 3 } 1 1 }  }
	{ lineBuffer_1 int 8 regular {array 640 { 1 3 } 1 1 }  }
	{ lineBuffer_2 int 8 regular {array 640 { 1 3 } 1 1 }  }
	{ empty_30 int 2 regular  }
	{ empty int 2 regular  }
...
set C_modelArgMapList {[ 
	{ "Name" : "tmp_2", "interface" : "wire", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "empty_30", "interface" : "wire", "bitwidth" : 2, "direction" : "READONLY"} , 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "empty_30", "direction": "in", "datatype": "sc_lv", "bitwidth":2, "type": "signal", "bundle":{"name": "empty_30", "role": "default" }} , 
...
set Spec2ImplPortList { 
	...
	lineBuffer { ap_memory {  { lineBuffer_address0 mem_address 1 10 }  { lineBuffer_ce0 mem_ce 1 1 }  { lineBuffer_q0 mem_dout 0 8 } } }
	lineBuffer_1 { ap_memory {  { lineBuffer_1_address0 mem_address 1 10 }  { lineBuffer_1_ce0 mem_ce 1 1 }  { lineBuffer_1_q0 mem_dout 0 8 } } }
	lineBuffer_2 { ap_memory {  { lineBuffer_2_address0 mem_address 1 10 }  { lineBuffer_2_ce0 mem_ce 1 1 }  { lineBuffer_2_q0 mem_dout 0 8 } } }
	empty_30 { ap_none {  { empty_30 in_data 0 2 } } }
