set moduleName grayscale_Pipeline_burst_read
set isTopModule 0
...
set C_modelArgMapList {[ 
	{ "Name" : "gmem0", "interface" : "axi_master", "bitwidth" : 512, "direction" : "READONLY", "id_num" : 0, "bitSlice":[ {"cElement": [{"cName": "in_r","offset": { "type": "dynamic","port_name": "in_r","bundle": "control"},"direction": "READONLY"}]}]} , 
 	{ "Name" : "row_words", "interface" : "memory", "bitwidth" : 512, "direction" : "WRITEONLY"} ]}
...
set portList { 
	...
	{ row_words_address0 sc_out sc_lv 5 signal 1 } 
	{ row_words_ce0 sc_out sc_logic 1 signal 1 } 
	{ row_words_we0 sc_out sc_logic 1 signal 1 } 
	{ row_words_d0 sc_out sc_lv 512 signal 1 } 
}
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "row_words_we0", "direction": "out", "datatype": "sc_logic", "bitwidth":1, "type": "signal", "bundle":{"name": "row_words", "role": "we0" }} , 
 	{ "name": "row_words_d0", "direction": "out", "datatype": "sc_lv", "bitwidth":512, "type": "signal", "bundle":{"name": "row_words", "role": "d0" }}  ]}
...
set Spec2ImplPortList { 
	...
	row_words { ap_memory {  { row_words_address0 mem_address 1 5 }  { row_words_ce0 mem_ce 1 1 }  { row_words_we0 mem_we 1 1 }  { row_words_d0 mem_din 1 512 } } }
}
