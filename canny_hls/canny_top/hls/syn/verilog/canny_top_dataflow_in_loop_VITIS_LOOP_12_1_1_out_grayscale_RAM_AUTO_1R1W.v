...
`timescale 1ns/1ps
(* DowngradeIPIdentifiedWarnings="yes" *) module canny_top_dataflow_in_loop_VITIS_LOOP_12_1_1_out_grayscale_RAM_AUTO_1R1W
#(parameter
    DataWidth    = 8,
    AddressRange = 512,
    AddressWidth = 9,
...
generate
    for (i = 0; i < BufferCount; i = i + 1) begin : gen_buffer
        canny_top_dataflow_in_loop_VITIS_LOOP_12_1_1_out_grayscale_RAM_AUTO_1R1W_memcore canny_top_dataflow_in_loop_VITIS_LOOP_12_1_1_out_grayscale_RAM_AUTO_1R1W_memcore_U (
            .ce0      ( buf_ce0[i] ),
            .address0 ( buf_a0[i] ),
            .we0      ( buf_we0[i] ),
            .d0       ( buf_d0[i] ),
