...
entity canny_top_fifo_w64_d9_S is 
    generic (
...
architecture rtl of canny_top_fifo_w64_d9_S is
...
------------------------Component----------------------
    component canny_top_fifo_w64_d9_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 9);
...
begin
----------------------- Instantiation -----------------------
    U_canny_top_fifo_w64_d9_S_ShiftReg : canny_top_fifo_w64_d9_S_ShiftReg
    generic map (
...
entity canny_top_fifo_w64_d9_S_ShiftReg is
    generic (
        DATA_WIDTH : integer := 64;
        ADDR_WIDTH : integer := 4;
        DEPTH      : integer := 9);
    port (
        ...
        din        : in std_logic_vector(DATA_WIDTH-1 downto 0);
        dout       : out std_logic_vector(DATA_WIDTH-1 downto 0));
end canny_top_fifo_w64_d9_S_ShiftReg;

architecture rtl of canny_top_fifo_w64_d9_S_ShiftReg is
